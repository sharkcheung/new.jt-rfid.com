...
//canvas元素相关
    ...
    canvas.style.cssText = "position:absolute;top:0;left:0;box-sizing: border-box;z-index:" + attr.z + ";opacity:" + attr.opacity;
    //将canvas元素添加到body元素中
    document.getElementsByClassName("product")[0].appendChild(canvas);
