...
subject      = productName		'订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。
body         = ""		        '订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
price    	 = pro_price		'订单总金额，显示在支付宝收银台里的“商品单价”里

logistics_fee		=pro_fee				'物流费用，即运费。
...
logistics_fee_1		= pro_fee					'物流费用，即运费。
logistics_type_1	= ""					'物流类型，三个值可选：EXPRESS（快递）、POST（平邮）、EMS（EMS）
logistics_payment_1	= "BUYER_PAY"					'物流支付方式，两个值可选：SELLER_PAY（卖家承担运费）、BUYER_PAY（买家承担运费）
