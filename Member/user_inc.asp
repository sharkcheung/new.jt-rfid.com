...
<div align="right">
<div align="center">
<table width="100%" border="1" cellpadding="3" style="border-collapse: collapse" bordercolor="#F1F5FC">
            <tr align="center"> 
              <td style="border-top:solid #ccc 1px;border-bottom:solid #ccc 1px;" bgcolor="#F1F5FC" align="center">订单号</td>
              <td style="border-top:solid #ccc 1px;border-bottom:solid #ccc 1px;" bgcolor="#F1F5FC" align="left">商品详情</td>
              <td style="border-top:solid #ccc 1px;border-bottom:solid #ccc 1px;" bgcolor="#F1F5FC" align="center">订单金额</td>
              <td style="border-top:solid #ccc 1px;border-bottom:solid #ccc 1px;" bgcolor="#F1F5FC" align="center">付款方式</td>
              <td style="border-top:solid #ccc 1px;border-bottom:solid #ccc 1px;" bgcolor="#F1F5FC" align="center">订单日期</td>
              <td style="border-top:solid #ccc 1px;border-bottom:solid #ccc 1px;" bgcolor="#F1F5FC" align="center">订单状态</td>
            </tr>
            <%
...
pro_paytype=rs("pro_paytype")%>
            <tr style="padding:0px;border-top:dashed 1px #CCC;border-bottom:dashed 1px #CCC;" onmouseover="this.style.backgroundColor='#FFFFCC';" onmouseout="this.style.backgroundColor='<%=bgcolor1%>'" style="background:<%=bgcolor%>;">
...
function passcheck()
{
    ...
    alert("密码长度不能不能这空，在6位到16位之间，请重新输入！");
	return false;
  }
