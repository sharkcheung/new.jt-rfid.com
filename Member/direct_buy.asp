        ...
        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" class="table-zuoyou" bordercolor="#CCCCCC" style="border:#CCCCCC solid 1px;">
          ...
          <form name="shouhuoxx" method="post" action="" onSubmit="ssxx">
            <tr bgcolor="#ffffff">
              ...
              <td width="70%" height="25" style="PADDING-LEFT: 20px" class="table-xia"><input name=userid type=hidden value="">
                  <input name="userzhenshiname" class="wenbenkuang" type="text" id="userzhenshiname" size="16" value="">
        性别：
        <select class="wenbenkuang" name="shousex" id="shousex">
          <option value=0 selected>男</option>
          <option value=1>女</option>
        </select><input type="hidden" name="p_id" value="<%=p_id%>" /><input type="hidden" name="danjia" value="<%=danjia%>" /><input type="hidden" name="p_name" value="<%=p_name%>" />
              </td>
            </tr>
            <tr bgcolor="#ffffff">
              <td width="30%" height="25" align="right" class="table-xia">详细地址：</td>
              <td width="70%" height="25" style="PADDING-LEFT: 20px" class="table-xia">
			  <input class="wenbenkuang" name="shouhuodizhi" type="text" id="shouhuodizhi" size="60" value="">
              </td>
            </tr>
            <tr bgcolor="#ffffff">
              <td width="30%" height="25" align="right" class="table-xia">邮政编码：</td>
              <td width="70%" height="25" style="PADDING-LEFT: 20px" class="table-xia"><input class="wenbenkuang" name="youbian" type="text" id="youbian" size="16" value="" ONKEYPRESS="event.returnValue=IsDigit();"></td>
            </tr>
            <tr bgcolor="#ffffff">
              <td width="30%" height="25" align="right" class="table-xia">手机号码：</td>
              <td width="70%" height="25" style="PADDING-LEFT: 20px" class="table-xia">
			  <input class="wenbenkuang" name="usertel" type="text" id="usertel" size="30" value='' style="height: 20px">
              </td>
            </tr>
            <tr bgcolor="#ffffff">
              <td width="30%" height="25" align="right" class="table-xia">电子邮件：</td>
              <td width="70%" height="25" style="PADDING-LEFT: 20px" class="table-xia"><input class="wenbenkuang" name="useremail" type="text" id="useremail" size="30" value="">
              </td>
            </tr>
            <tr bgcolor="#ffffff">
...
<option value="100000" >货到付款</option>--></select></td>
            ...
            <tr bgcolor="#ffffff">
              ...
              <td height="40">&nbsp; &nbsp; <input class="go-wenbenkuang" type="button" name="Submit4" value="确认收货信息 下一步" onclick='return ssxx();'></td>
            </tr>
          </form>
        </table>
                  ...
                  <td align="center" valign="top" height=50 colspan=2>
                      ...
                      <table width=99% border=0 cellspacing=1 bgcolor=#cccccc>
                        ...
                        <tr align="center" bgcolor=#ffffff>
                          <td height="22" align="left">　<%=p_name%>
                              <input name=bookid2 type=hidden value="<%=p_id%>">
                          </td>
                          <td><%=danjia%>
                  元</td>
                          <td>1</td>
	  	...
	  	response.write "<script language=javascript>alert('您的预存款不足，请更换支付方式！');history.go(-1);</script>"
                  ...
                  <tr bgcolor="#ffffff" align="center">
                    ...
                    是否要发票？-->
					  ...
					  <input name="pronum" type="hidden" value=1>
					  <input name="bjxbookname" type="hidden" value="<%=p_name%>">
...
set rs=server.CreateObject("adodb.recordset")
rs.open "select * from u_order",connn,1,3
if rs.eof then
'得到价格，减库存
rs.addnew
rs("p_id")=bookid2
