...
merchantAcctId=request("cid")
'merchantAcctId="1001155307501"
'人民币网关密钥
''区分大小写.请与快钱联系索取
key=request("mykey")
...
m_bgUrl="http://" & Request.ServerVariables("HTTP_HOST") & Mid(Request.ServerVariables("URL"),1,InStrRev(Request.ServerVariables("URL"),"/"))
bgUrl=m_bgUrl&"/kqpay/receive.asp"
...
'商品名称
''可为中文或英文字符
productName=trim(request("productid"))
productName=replace(productName," ","&nbsp;")
'if len(productName1)>10 then
'productName=left(productName1,8)
'else
...
'商品数量
''可为空，非空时必须为数字
productNum=session("pro_pro_num")
'商品代码
''可为字符或者数字
productId=""
...
.td{color:#DD6F00; font-size:12px;}
...
<BODY>
	...
	<div align="center" style="margin:0 auto; margin-top:200px; font-size:12px;">
		<table width="381" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" >
	  <tr bgcolor="#FFFFFF">
				<td width="80" class="td">支付方式:</td>
				<td width="232" class="td1">快钱[99bill]</td>
		  </tr>
			<tr bgcolor="#FFFFFF">
				<td class="td">订单编号:</td>
			...
			<tr bgcolor="#FFFFFF">
				<td class="td">订单金额:</td>
				<td class="td1"><%=orderAmount/100%>.00 元</td>
			</tr>
			<tr bgcolor="#FFFFFF">
				<td class="td">支付人:</td>
				<td class="td1"><%=payerName %></td>
			</tr>
			<tr bgcolor="#FFFFFF">
				<td class="td">商品名称:</td>
	...
	<div align="center" style="font-size=12px;font-weight: bold;color:red; padding:10px;">
