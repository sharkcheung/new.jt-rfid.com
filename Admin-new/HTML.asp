...
<table width="100%" border="0"align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <select style="margin:0 10px 0 0; width:150px; vertical-align:middle;" name="MenuId" class="Input" id="MenuId" onchange="ChangeSelect('Ajax.asp?Type=1&Temp=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId');">
