...
Public Function GetFileSize(FileName)
	if FileName="" then GetFileSize="-":exit function
	Dim fso,drvpath,d,size,showsize,filepath
...
<div class="pageright xgzs ssyqtj" style="border-top:0;">
	<div class="xgzstop" style="border:1px solid #ceecff; border-bottom:0;">
		<div class="xgzstop_top gnsztopbtn">
			<a class="no2" href="javascript:void(0);" onclick="ShowBox('/admin-new/weixin/weixin_Sucai.asp?Type=11','添加语音');return false;">添加语音</a>
			<a class="no3" href="javascript:void(0);" onclick="ShowBox('/admin-new/weixin/weixin_Sucai.asp?Type=2','添加图片');return false;">添加图片</a>
		</div>
	</div>
	<div class="xgzsbtm" style="padding-top:0;">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="khdtj">
			...
			<th align="center" class="ListTdTop" width="120">名称</th>
			<th align="center" class="ListTdTop" width="80">类型</th>
			<th align="center" class="ListTdTop" width="80">来源</th>
			<th align="center" class="ListTdTop" width="80">素材</th>
			<th align="center" class="ListTdTop" width="120">大小</th>
			<th align="center" class="ListTdTop" width="80">排序</th>
			<th align="center" class="ListTdTop" width="140">时间</th>
			<th align="center" class="ListTdTop" width="70">状态</th>
...
response.write GetFileSize(Rs("Sucai_file"))
end if%></td>
<td align="center"><input style="width:30px" type="text" value="<%=Rs("Sucai_px")%>" class="Input" name="px" size=2 style="text-align:center"/></td>
...
<td align="center"><a href="javascript:void(0);" onclick="ShowBox('/admin-new/weixin/weixin_Sucai.asp?Type=<%=t%>&Id=<%=Rs("id")%>','修改图片素材');return false;"><img src="/admin/images/edit.png" title="编辑"></a> </td>
</tr>
<%
Rs.MoveNext
i=i+1
...
<input name="chkall" type="checkbox" id="chkall" value="select" onClick="CheckAll(this.form)" style='vertical-align:middle; margin-left:34px;  margin-right:2px;'> 全选
<input type="submit" value="排序" class="Button" onClick="if($('input.Checks:checked').length<1){layer.msg('请先选择要批量操作的数据！');return false};Sends('DelList','/admin-new/weixin/weixin_Sucai.asp?Type=7',0,'',0,1,'MainRight','<%=Session("NowPage")%>');" style='vertical-align:middle; margin-right:5px; margin-left:10px;'>
<input type="submit" value="启用" class="Button" onClick="if($('input.Checks:checked').length<1){layer.msg('请先选择要批量操作的数据！');return false};Sends('DelList','/admin-new/weixin/weixin_Sucai.asp?Type=8',0,'',0,1,'MainRight','<%=Session("NowPage")%>');" style='vertical-align:middle; margin-right:5px;'>
<input type="submit" value="禁用" class="Button" onClick="if($('input.Checks:checked').length<1){layer.msg('请先选择要批量操作的数据！');return false};Sends('DelList','/admin-new/weixin/weixin_Sucai.asp?Type=9',0,'',0,1,'MainRight','<%=Session("NowPage")%>');" style='vertical-align:middle; margin-right:5px;'>
<input type="submit" value="删除" class="Button" onClick="if($('input.Checks:checked').length<1){layer.msg('请先选择要批量操作的数据！');return false};Sends('DelList','/admin-new/weixin/weixin_Sucai.asp?Type=6',0,'',0,1,'MainRight','<%=Session("NowPage")%>');" style='vertical-align:middle; margin-right:5px;'></td>
</tr>
<tr>
<td height="30" colspan="10" align="center"><%Call FKFun.ShowPageCode("Down.asp?Type=1&SearchStr="&Server.URLEncode(SearchStr)&"&Page=",PageNow,PageAll,PageSizes,PageCounts)%></td>
</tr>
<%
Else
%>
...
<script type="text/javascript">	
				...
				if($(".Fk_Sucai_source:checked").val()==0){
					...
					$(".uploadclass").html(" <input type=\"button\" id=\"uploadButton\" value=\"上传\" class=\"Button\" style=\"vertical-align:middle;\"/> "+h+"");
						...
						$('#uploadButton').bind("click",function() {
								var editor = window.KindEditor.editor({
									fileManagerJson : '/admin/dkidtioenr/aps/file_manager_json.asp',
									uploadJson		: '/admin-new/weixin/upload_json.asp',
									allowFileManager : true
								});
    ...
    $(document).ready(function() {
		...
		$(".MusicCj").bind("click",function(){
			...
			ymPrompt.win({message:'/admin-new/weixin/weixin_MusicCj.asp?type=1&id=0',
				width : 800,
				height :450,
				title:'采集语音',
				btn: [['确定','ok'],['关闭','close']],
...
<form id="WeixinAdd" name="WeixinAdd" method="post" action="/admin-new/weixin/weixin_Sucai.asp?Type=3" onsubmit="return false;">
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	    ...
	    <tr>
	        ...
	        <td><input name="Fk_Sucai_source" type="radio" class="Fk_Sucai_source" id="Fk_Sucai_source" style="vertical-align:middle;" value="0"  checked="checked"/> <label for="Fk_Sucai_source" style="vertical-align:middle;">外链</label> &nbsp; <input name="Fk_Sucai_source" type="radio" class="Fk_Sucai_source" id="Fk_Sucai_source1"  style="vertical-align:middle;" value="1"/> <label for="Fk_Sucai_source1" style="vertical-align:middle;">上传</label></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	        ...
	        <td><textarea name="Fk_Sucai_desc" id="Fk_Sucai_desc" class="Input" style="height:70px;width:440px;"></textarea></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	        ...
	        <td><input name="Fk_Sucai_status"type="radio" id="Fk_Sucai_status" value="0" checked="checked"  style="vertical-align:middle;"/> <label for="Fk_Sucai_status" style="vertical-align:middle;">启用</label>
            &nbsp; <input type="radio" name="Fk_Sucai_status" id="Fk_Sucai_status1" value="1"  style="vertical-align:middle;"/> <label for="Fk_Sucai_status1" style="vertical-align:middle;">禁用</label></td>
	        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left" class="tcbtm">
        <input type="submit" style="margin-left:113px;" onclick="Sends('WeixinAdd','/admin-new/weixin/weixin_Sucai.asp?Type=3',0,'',0,1,'MainRight','/admin-new/weixin/weixin_Sucai.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
...
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	    ...
	    <tr>
	        <td height="25" align="right">来源：</td>
	        <td><input name="Fk_Sucai_source" type="radio" class="Fk_Sucai_source" id="Fk_Sucai_source" style="vertical-align:middle;" value="0" <%if Fk_Sucai_source=0 then response.write "checked=""checked"""%> /> <label for="Fk_Sucai_source" style="vertical-align:middle;">外链</label> &nbsp; <input name="Fk_Sucai_source" type="radio" class="Fk_Sucai_source" id="Fk_Sucai_source1"  style="vertical-align:middle;" value="1" <%if Fk_Sucai_source=1 then response.write "checked=""checked"""%>/> <label for="Fk_Sucai_source1" style="vertical-align:middle;">上传</label></td>
	    </tr>
	    <tr>
	        <td height="25" align="right">素材：</td>
	        <td><input name="Fk_Sucai_url" id="Fk_Sucai_url" class="Input" size="60"  value="<%=Fk_Sucai_url%>" style="margin-right:5px;"/><div class="uploadclass"><%if Fk_Sucai_source=1 then 
			response.write "<input type=""button"" id=""uploadButton"" value=""上传"" class=""Button"" style=""vertical-align:middle;""/><br /><span> 文件小于500k；推荐格式：png, jpg, gif, bmp</span>"
			else
	    ...
	    <tr>
	        ...
	        <td><textarea name="Fk_Sucai_Summary" id="Fk_Sucai_Summary" class="Input" style="height:70px;width:440px;"><%=Fk_Sucai_Summary%></textarea></td>
	    </tr>
	    <tr>
	        <td height="25" align="right">排序：</td>
	    ...
	    <tr>
	        <td height="25" align="right">状态：</td>
	        <td><input name="Fk_Sucai_status" type="radio" id="Fk_Sucai_status" value="0" checked="checked" <%if Fk_Sucai_status=0 then response.write "checked"%>  style="vertical-align:middle;"/> <label for="Fk_Sucai_status" style="vertical-align:middle;">启用</label>
            <input type="radio" name="Fk_Sucai_status" id="Fk_Sucai_status1" value="1" <%if Fk_Sucai_status=1 then response.write "checked"%>  style="vertical-align:middle;"/> <label for="Fk_Sucai_status1" style="vertical-align:middle;">禁用</label></td>
	        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:93%; text-align:left; margin:0 auto;" class="tcbtm">
        <input type="submit" style="margin-left:113px;" onclick="Sends('WeixinAdd','/admin-new/weixin/weixin_Sucai.asp?Type=5',0,'',0,1,'MainRight','/admin-new/weixin/weixin_Sucai.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="layer.closeAll();$('select').show();" class="Button close" name="button" id="button" value="关 闭" />
</div>
</form>
<%
...
<form id="WeixinAdd" name="WeixinAdd" method="post" action="/admin-new/weixin/weixin_Sucai.asp?Type=12" onsubmit="return false;">
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right" width="100">标题：</td>
	    ...
	    <tr>
	        <td height="25" align="right">来源：</td>
	        <td style="padding-left:10px;"><input name="Fk_Sucai_source" type="radio" class="Fk_Sucai_source" id="Fk_Sucai_source" style="vertical-align:middle;" value="0"  checked="checked"/> <label for="Fk_Sucai_source" style="vertical-align:middle;">外链</label> &nbsp; <input name="Fk_Sucai_source" type="radio" class="Fk_Sucai_source" id="Fk_Sucai_source1"  style="vertical-align:middle;" value="1"/> <label for="Fk_Sucai_source1" style="vertical-align:middle;">上传</label></td>
	    </tr>
	    <tr>
	        <td height="25" align="right">素材：</td>
	    ...
	    <tr>
	        <td height="25" align="right">状态：</td>
	        <td style="padding-left:10px;"><input name="Fk_Sucai_status" type="radio" id="Fk_Sucai_status" value="0" checked="checked"  style="vertical-align:middle;"/> <label for="Fk_Sucai_status" style="vertical-align:middle;">启用</label>
            &nbsp; <input type="radio" name="Fk_Sucai_status" id="Fk_Sucai_status1" value="1"  style="vertical-align:middle;"/> <label for="Fk_Sucai_status1" style="vertical-align:middle;">禁用</label></td>
	        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left;" class="tcbtm">
        <input type="submit" style="margin-left:113px;" onclick="Sends('WeixinAdd','/admin-new/weixin/weixin_Sucai.asp?Type=12',0,'',0,1,'MainRight','/admin-new/weixin/weixin_Sucai.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
        <input type="button" onclick="layer.closeAll();$('select').show();" class="Button close" name="button" id="button" value="关 闭" />
</div>
</form>
<%
...
<form id="WeixinAdd" name="WeixinAdd" method="post" action="/admin-new/weixin/weixin_Sucai.asp?Type=14" onsubmit="return false;">
<div id="BoxContents" style="width:93%; padding-top:20px">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right" width="100">标题：</td>
	    ...
	    <tr>
			...
			response.write "<br /><input type=""button"" id=""uploadButton"" value=""上传"" class=""Button"" style=""vertical-align:middle;""/> <span> 文件小于500k；推荐格式：png, jpg, gif, bmp</span>"
			else
			response.write "<span> 推荐格式：png, jpg, gif, bmp</span>"
			end if
			%></div></td>
...
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left" class="tcbtm">
        <input style="margin-left:113px;" type="submit" onclick="Sends('WeixinAdd','/admin-new/weixin/weixin_Sucai.asp?Type=14',0,'',0,1,'MainRight','/admin-new/weixin/weixin_Sucai.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="layer.closeAll();$('select').show();" class="Button close" name="button" id="button" value="关 闭" />
</div>
</form>
<%
...
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left" class="tcbtm">
        <input style="margin-left:113px;" type="submit" onclick="Sends('WeixinAdd','/admin-new/weixin/weixin_Sucai.asp?Type=5',0,'',0,1,'MainRight','/admin-new/weixin/weixin_Sucai.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="layer.closeAll();$('select').show();" class="Button close" name="button" id="button" value="关 闭" />
</div>
