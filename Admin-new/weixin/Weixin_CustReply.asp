            ...
            <div class="pageright xgzs ssyqtj" style="border-top:0;">
            	<div class="xgzstop" style="border:1px solid #ceecff; border-bottom:0;">
                	<div class="xgzstop_top gnsztopbtn">
                    	<h3>自定义回复模块：</h3>
                        <input name="SearchStr" value="<%=SearchStr%>" type="text" class="Input" id="SearchStr" style="vertical-align:middle;"/>&nbsp;
                        <input type="button" class="Button" onclick="SetRContent('MainRight','/admin-new/weixin/Weixin_CustReply.asp?Type=1&SearchStr='+escape(document.all.SearchStr.value));" name="S" Id="S" value="  查询  "  style="vertical-align:middle;"/>&nbsp;&nbsp;
                        <h3>请选择模块：</h3>
                        ...
                        <a class="no4" href="javascript:void(0);" onclick="ShowBox('/admin-new/weixin/Weixin_CustReply.asp?Type=2','添加自定义回复');return false;">添加</a>
                    </div>
                </div>
            	<div class="xgzsbtm" style="padding-top:0;">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="khdtj">
                        ...
                        <th align="center" class="ListTdTop" width="300">问题</th>
...
%>
            ...
            <td align="center"><a href="javascript:void(0);" onclick="ShowBox('/admin-new/weixin/Weixin_CustReply.asp?Type=4&Id=<%=Rs("id")%>','修改自定义回复');return false;"><img src="/admin/images/edit.png"></a> <a href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("reply_qtitle")%>”，此操作不可逆！','/admin-new/weixin/Weixin_CustReply.asp?Type=6&Id=<%=Rs("id")%>','MainRight','<%=Session("NowPage")%>');return false;"><img src="/admin/images/del.png"></a></td>
        </tr>
<%
			Rs.MoveNext
			i=i+1
...
%>
        <tr>
            ...
            <input type="submit" value="删 除" class="Button" onClick="if(confirm('此操作无法恢复！！！请慎重！！！\n\n确定要删除选中的下载吗？')){Sends('DelList','/admin-new/weixin/Weixin_CustReply.asp?Type=6',0,'',0,1,'MainRight','<%=Session("NowPage")%>');}" style='vertical-align:middle; margin-left:10px;'></td>
        </tr>
<%
	Else
%>
...
$(document).ready(function(){
		...
		$('.plus').click(function() {
			...
			if($(this).hasClass('answer') && $('#reply_type2').is(':checked')) {
				// 图文
				ymPrompt.win({message:'/admin-new/weixin/weixin_getNewsList.asp?type=1&id=0',
					width : 600,
					height : 350,
					title:'选择图文',
					btn: [['确定','ok'],['关闭','close']],
				...
				// 语音
				ymPrompt.win({message:'/admin-new/weixin/weixin_getMusicList.asp?type=1&id=0',
					width : 600,
					height : 350,
					title:'选择语音',
					btn: [['确定','ok'],['关闭','close']],
...
<form id="WeixinAdd" name="WeixinAdd" method="post" action="/admin-new/weixin/Weixin.asp?Type=3" onsubmit="updateItems();return false;">
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="100%" class="table_form" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right" width="100" style="vertical-align:top">问题：</td>
			...
			<div class="alert-col" style="padding-left:10px;">点击右边的添加按钮，可设置多个相似问题。 </div></td>
	    </tr>
	    <tr>
	        <td height="25" align="right">回复类型：</td>
	        <td style="padding-left:10px;"><span class="fr">支持同时编辑多种回复类型，回复优先级: 图文 > 语音 > 文本</span><input name="reply_type" type="radio" id="reply_type1" value="0" style="verticle-align:middle"/> <label for="reply_type1" style="verticle-align:middle">文本</label> &nbsp; <input name="reply_type" id="reply_type2"  type="radio" value="2" style="verticle-align:middle"/> <label for="reply_type2" style="verticle-align:middle">图文</label> &nbsp; <input name="reply_type" type="radio" id="reply_type3" value="3" style="verticle-align:middle"/> <label for="reply_type3" style="verticle-align:middle">语音</label> </td>
	        </tr>
	    <tr>
...
<div style="background-image:url(http://static.v5kf.com/images/emoji/default/不好意思.png)" code="不好意思" title="不好意思" class="emj">[emot=不好意思/]</div>
				...
				<ul>
					...
					<div class="alert-col" style="padding-left:10px;">可设置多个备选回复(默认为随机回复，关闭随机将优先排列靠前的回复) &nbsp; 没有图文请到 微信管理-&gt;<a href="javascript:void(0);" class="green" onclick="layer.closeAll();SetRContent('MainRight','weixin_ImgText.asp?Type=1');return false;">图文管理</a> 添加</div>
				</div>
				<div class="explain-col reply_rs hide" style="display: block;">
				<input type="hidden" name="resource" id="resource" value="">
				<ul>
								</ul>
				<div class="alert-col" style="padding-left:10px;">可设置多个备选回复(默认为随机回复，关闭随机将优先排列靠前的回复) &nbsp; 没有语音素材请到 内容管理-&gt;素材管理--&gt;<a href="javascript:void(0);" onclick="layer.closeAll();SetRContent('MainRight','Weixin_Sucai.asp?Type=1');return false;" class="green">素材列表</a> 添加</div>
			</div>
			</td>
	        </tr>
	    </table>
...
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left" class="tcbtm">
        <input style="margin-left:113px;" type="submit" onclick="Sends('WeixinAdd','/admin-new/weixin/Weixin_CustReply.asp?Type=3',0,'',0,1,'MainRight','/admin-new/weixin/Weixin_CustReply.asp?Type=1');" class="Button" name="button" id="button" value="提 交" />
...
$(document).ready(function(){
		...
		$('.plus').click(function() {
			var parent, html;
			if($(this).hasClass('answer') && $('#reply_type2').is(':checked')) {
				ShowBox('/admin-new/weixin/weixin_getNewsList.asp?type=1&id=0','选择图文');
				// 图文
				/*y
				layer.open({
					type: 2,
					...
					shade: 0.8,
					area: ['380px', '90%'],
					content: '/admin-new/weixin/weixin_getNewsList.asp?type=1&id=0' //iframe的url
				}); mPrompt.win({message:'/admin-new/weixin/weixin_getNewsList.asp?type=1&id=0',
					width : 600,
					height : 350,
					title:'选择图文',
					btn: [['确定','ok'],['关闭','close']],
...
<form id="WeixinAdd" name="WeixinAdd" method="post" action="/admin-new/weixin/Weixin_CustReply.asp?Type=5" onsubmit="updateItems();return false;"><input type="hidden" value="<%=id%>" name="id"/>
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="100%" border="0" align="center" class="table_form" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right" width="100">问题：</td>
	        <td><a href="javascript: void(0);" class="rndBtn plus fr question" title="添加问题"></a>
			<ul>
	    ...
	    <tr>
	        <td height="25" align="right">回复类型：</td>
	        <td style="padding-left:10px;"><span class="fr">支持同时编辑多种回复类型，回复优先级: 图文 > 语音 > 文本</span><input name="reply_type" type="radio" id="reply_type1" value="0" style="verticle-align:middle"/> <label for="reply_type1" style="verticle-align:middle">文本</label> &nbsp; <input name="reply_type" type="radio" id="reply_type2" value="2" style="verticle-align:middle"/> <label for="reply_type2" style="verticle-align:middle">图文</label> &nbsp; <input name="reply_type" type="radio" id="reply_type3" value="3" style="verticle-align:middle"/> <label for="reply_type3" style="verticle-align:middle">语音</label> </td>
	        </tr>
	    <tr>
	        <td height="25" align="right">回复内容：</td>
	        <td><a href="javascript: void(0);" class="rndBtn plus fr answer" title="添加回复"></a>
...
<div style="background-image:url(http://static.v5kf.com/images/emoji/default/不好意思.png)" code="不好意思" title="不好意思" class="emj">[emot=不好意思/]</div>
				...
				<%end if
					...
					<div class="alert-col" style="padding-left:10px;">可设置多个备选回复(默认为随机回复，关闭随机将优先排列靠前的回复) &nbsp; <!--可设置多个备选回复，优先匹配排列靠前的回复，超过有效期将选择备选图文。-->没有图文请到 微信管理-&gt;<a href="javascript:void(0);" onclick="layer.closeAll();SetRContent('MainRight','weixin_ImgText.asp?Type=1');return false;" class="green">图文管理</a> 添加</div>
				</div>
				...
				<div class="alert-col" style="padding-left:10px;">可设置多个备选回复(默认为随机回复，关闭随机将优先排列靠前的回复) &nbsp; 没有语音素材请到 内容管理-&gt;素材管理--&gt;<a href="javascript:void(0);" onclick="layer.closeAll();SetRContent('MainRight','Weixin_Sucai.asp?Type=1');return false;" class="green">素材列表</a>素材列表</a> 添加</div>
			</div>
			</td>
	        </tr>
	    </table>
...
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left" class="tcbtm">
        <input style="margin-left:113px;" type="submit" onclick="Sends('WeixinAdd','/admin-new/weixin/Weixin_CustReply.asp?Type=5',0,'',0,1,'MainRight','/admin-new/weixin/Weixin_CustReply.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="layer.closeAll();$('select').show();" class="Button close" name="button" id="button" value="关 闭" />
</div>
</form>
<%
...
rs.close
%>
<form id="WeixinAdd" name="WeixinAdd" method="post" action="/admin-new/weixin/Weixin_CustReply.asp?Type=8" onsubmit="return false;">
...
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left" class="tcbtm">
        <input style="margin-left:113px;" type="submit" onclick="Sends('WeixinAdd','/admin-new/weixin/Weixin_CustReply.asp?Type=8',0,'',0,1,'MainRight','/admin-new/weixin/Weixin_CustReply.asp?Type=1');" class="Button" name="button" id="button" value="生 成" />
        <input type="button" onclick="layer.closeAll();$('select').show();" class="Button close" name="button" id="button" value="关 闭" />
</div>
</form>
<%
