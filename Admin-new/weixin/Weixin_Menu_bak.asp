...
<div id="ListNav">
    <ul>
        <li><a href="javascript:void(0);" onclick="SetRContent('MainRight','<%=Session("NowPage")%>');return false;">自定义菜单</a></li>
        <li><a href="javascript:void(0);" onclick="ShowBox('/admin/weixin/weixin_menu.asp?Type=2');return false;">添加</a></li>
        <li><a href="javascript:void(0);" onclick="ShowBox('/admin/weixin/weixin_menu.asp?Type=7');return false;">生成微信菜单</a></li>
    </ul>
</div>
<div id="ListContent">
...
%>
        <tr>
            ...
            <td align="center"><a href="javascript:void(0);" onclick="ShowBox('/admin/weixin/weixin_menu.asp?Type=4&Id=<%=Rs("id")%>');return false;"><img src="/admin/images/edit.png"></a> <a href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("menuName")%>”，此操作不可逆！','/admin/weixin/weixin_menu.asp?Type=6&Id=<%=Rs("id")%>','MainRight','<%=Session("NowPage")%>');return false;"><img src="/admin/images/del.png"></a></td>
        </tr>
...
do while not rs2.eof%>
        ...
        <tr class="subtr">
            ...
            <td align="center"><a href="javascript:void(0);" onclick="ShowBox('/admin/weixin/weixin_menu.asp?Type=4&Id=<%=rs2("id")%>');return false;"><img src="/admin/images/edit.png"></a> <a href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=rs2("menuName")%>”，此操作不可逆！','/admin/weixin/weixin_menu.asp?Type=6&Id=<%=rs2("id")%>','MainRight','<%=Session("NowPage")%>');return false;"><img src="/admin/images/del.png"></a></td>
        </tr>
<%
rs2.movenext
loop
...
%>
        <tr>
            ...
            <input type="submit" value="删 除" class="Button" onClick="if(confirm('此操作无法恢复！！！请慎重！！！\n\n确定要删除选中的下载吗？')){Sends('DelList','/admin/weixin/weixin_menu.asp?Type=6',0,'',0,1,'MainRight','<%=Session("NowPage")%>');}" style='vertical-align:middle'></td>
        </tr>
<%
	Else
%>
