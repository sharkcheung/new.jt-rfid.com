...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="mbbqscq">
	<tr>
    	<th colspan="5" style="height:0; border-top:0;"></th>
    </tr>
    <tr>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=1');">全站常规标签</a></td>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=30');">统计和客服代码</a><!--<a href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=2');">静态页常规标签</a>--></td>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=3');">单页常规标签</a></td>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=4');">新闻列表页常规标签</a></td>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=6');">新闻页常规标签</a></td>
        </tr>
    <tr>
        <td height="22" align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=5');">图文列表页常规标签</a></td>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=7');">图文页常规标签</a></td>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=12');">下载列表页常规标签</a></td>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=13');">下载页常规标签</a></td>
        <td align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=8');">留言类页专用标签</a></td>
    </tr>
    <tr>
        <td height="22" align="center"><a style="width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=10');">IF标签使用方法</a></td>
        <td align="center"><a style="color: #CCCCCC; width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=11');">搜索页标签</a></td>
        <td align="center"><a style="color: #CCCCCC; width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=14');">招聘页标签(暂)</a></td>
        <td align="center"><a style="color: #CCCCCC; width:auto;height:31px; background:none;" href="javascript:void(0);" onclick="SetRContent('Template','TemplateHelp.asp?Type=2&Id=9');">专题页标签(暂)</a></td>
        <td align="center"></td>
    </tr>
<form id="Get1" name="Get1" method="post" action="TemplateHelp.asp?Type=3&Id=1" onsubmit="return false;">
    <tr>
        ...
        <select name="MenuId1" id="MenuId1" onchange="ChangeSelect('Ajax.asp?Type=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId1');">
...
%>
            ...
            <select name="GetCount1" id="GetCount1">
            ...
            <select name="GetCount2" id="GetCount2">
...
<form id="Get2" name="Get2" method="post" action="TemplateHelp.asp?Type=3&Id=2" onsubmit="return false;">
    <tr>
        ...
        <td height="22" colspan="4" style="padding:5px;">
        <select name="MenuId2" id="MenuId2" onchange="ChangeSelect('Ajax.asp?Type=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId2');">
                <option value="">请选择菜单</option>
<%
	Sqlstr="Select * From [Fk_Menu] Order By Fk_Menu_Id Asc"
	Rs.Open Sqlstr,Conn,1,3
...
%>
        ...
        <select name="ModuleId2" id="ModuleId2">
                <option value="">请先选择菜单</option>
        </select>
        <select name="GetType1" id="GetType1">
        ...
        <select name="GetCount3" id="GetCount3">
...
%>
         ...
         <select name="GetType2" id="GetType2">
                <option value="0">不分页</option>
                <option value="1">分页</option>
        </select>
         <select name="GetType3" id="GetType3">
...
%>
         ...
         <select name="GetType4" id="GetType4">
...
%>
        ...
        <select name="GetCount7" id="GetCount7">
...
<form id="Get3" name="Get3" method="post" action="TemplateHelp.asp?Type=3&Id=3" onsubmit="return false;">
    <tr>
        ...
        <td height="22" colspan="4" style="padding:5px;">
        <select name="MenuId3" id="MenuId3" onchange="ChangeSelect('Ajax.asp?Type=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId3');">
                <option value="">请选择菜单</option>
<%
	Sqlstr="Select * From [Fk_Menu] Order By Fk_Menu_Id Asc"
	Rs.Open Sqlstr,Conn,1,3
...
%>
        ...
        <select name="ModuleId3" id="ModuleId3">
                <option value="">请先选择菜单</option>
        </select>
        <select name="GetType5" id="GetType5">
                <option value="0">按ID倒序</option>
                <option value="1">按时间倒序</option>
                <option value="2">按点击倒序</option>
                <option value="3">按ID正序</option>
        ...
        <select name="GetCount4" id="GetCount4">
                <option value="0">无需设置条数（分页模式）</option>
<%
	For i=1 To 20
%>
...
%>
         ...
         <select name="GetType6" id="GetType6">
                <option value="0">不分页</option>
                <option value="1">分页</option>
        </select>
         <select name="GetType7" id="GetType7">
...
%>
         ...
         <select name="GetType8" id="GetType8">
...
%>
        ...
        <select name="GetCount8" id="GetCount8">
                <option value="0">读取全部标题</option>
<%
	For i=1 To 20
%>
...
<form id="Get8" name="Get8" method="post" action="TemplateHelp.asp?Type=3&Id=8" onsubmit="return false;">
    <tr>
        ...
        <td height="22" colspan="4" style="padding:5px;">
        <select name="MenuId5" id="MenuId5" onchange="ChangeSelect('Ajax.asp?Type=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId5');">
                <option value="">请选择菜单</option>
<%
	Sqlstr="Select * From [Fk_Menu] Order By Fk_Menu_Id Asc"
	Rs.Open Sqlstr,Conn,1,3
...
%>
        ...
        <select name="ModuleId5" id="ModuleId5">
                <option value="">请先选择菜单</option>
        </select>
        <select name="GetType15" id="GetType15">
                <option value="0">按ID倒序</option>
                <option value="1">按时间倒序</option>
                <option value="2">按点击倒序</option>
                <option value="3">按ID正序</option>
        ...
        <select name="GetCount9" id="GetCount9">
                <option value="0">无需设置条数（分页模式）</option>
<%
	For i=1 To 20
%>
...
%>
         ...
         <select name="GetType16" id="GetType16">
                <option value="0">不分页</option>
                <option value="1">分页</option>
        </select>
         <select name="GetType17" id="GetType17">
...
%>
         ...
         <select name="GetType18" id="GetType18">
...
%>
        ...
        <select name="GetCount10" id="GetCount10">
                <option value="0">读取全部标题</option>
<%
	For i=1 To 20
%>
...
<form id="Get11" name="Get11" method="post" action="TemplateHelp.asp?Type=3&Id=11" onsubmit="return false;">
   <tr>
       ...
       <td height="22" colspan="4" style="padding:5px;">
        <select name="MenuId7" id="MenuId7" onchange="ChangeSelect('Ajax.asp?Type=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId7');">
                <option value="">请选择菜单</option>
<%
	Sqlstr="Select * From [Fk_Menu] Order By Fk_Menu_Id Asc"
	Rs.Open Sqlstr,Conn,1,3
...
%>
        ...
        <select name="ModuleId7" id="ModuleId7">
                <option value="">请先选择菜单</option>
        </select>
        <select name="GetCount11" id="GetCount11">
                <option value="0">无需设置条数（分页模式）</option>
<%
	For i=1 To 20
%>
...
%>
        ...
        <select name="GetType21" id="GetType21">
                <option value="0">所有记录</option>
                <option value="1">已回复记录</option>
        </select>
         <select name="GetType22" id="GetType22">
                <option value="0">不分页</option>
                <option value="1">分页</option>
        </select>
...
<form id="Get4" name="Get4" method="post" action="TemplateHelp.asp?Type=3&Id=4" onsubmit="return false;">
   <tr>
        ...
        <td height="22" colspan="4" style="padding:5px;">
         <select name="GetType9" id="GetType9">
<%
...
%>
        ...
        <select name="GetType10" id="GetType10">
                <option value="1">LOGO模式</option>
                <option value="2">文字模式</option>
        </select>
        <select name="GetCount5" id="GetCount5">
...
<form id="Get5" name="Get5" method="post" action="TemplateHelp.asp?Type=3&Id=5" onsubmit="return false;">
    <tr style="display:none">
        ...
        <td height="22" colspan="4" style="padding:5px;">
        <select name="GetCount6" id="GetCount6">
...
%>
        ...
        <select name="GetType11" id="GetType11">
                <option value="0">所有</option>
...
<form id="Get7" name="Get7" method="post" action="TemplateHelp.asp?Type=3&Id=7" onsubmit="return false;">
    <tr>
        ...
        <td height="22" colspan="4" style="padding:5px;">
        <select name="MenuId4" id="MenuId4" onchange="ChangeSelect('Ajax.asp?Type=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId4');">
                <option value="">请选择菜单</option>
<%
	Sqlstr="Select * From [Fk_Menu] Order By Fk_Menu_Id Asc"
	Rs.Open Sqlstr,Conn,1,3
...
%>
        ...
        <select name="ModuleId4" id="ModuleId4">
                <option value="">请先选择菜单</option>
        </select>
        <select name="GetType12" id="GetType12">
                <option value="1">默认FLASH轮换方案</option>
        </select>
        宽度：<input type="text" name="GetType13" id="GetType13" class="Input" />
        高度：<input type="text" name="GetType14" id="GetType14" class="Input" />
...
<form id="Get9" name="Get9" method="post" action="TemplateHelp.asp?Type=3&Id=9" onsubmit="return false;">
    <tr>
        ...
        <td height="22" colspan="4" style="padding:5px;">
        <select name="MenuId6" id="MenuId6" onchange="ChangeSelect('Ajax.asp?Type=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId6');">
                <option value="">请选择菜单</option>
<%
	Sqlstr="Select * From [Fk_Menu] Order By Fk_Menu_Id Asc"
	Rs.Open Sqlstr,Conn,1,3
...
%>
        ...
        <select name="ModuleId6" id="ModuleId6">
                <option value="">请先选择菜单</option>
        </select>
...
<form id="Get10" name="Get10" method="post" action="TemplateHelp.asp?Type=3&Id=10" onsubmit="return false;">
    <tr>
        ...
        <td height="22" colspan="4" style="padding:5px;">
        <select name="GetType19" id="GetType19">
...
<form id="Get15" name="Get15" method="post" action="TemplateHelp.asp?Type=3&Id=15" onsubmit="return false;">
    <tr>
        ...
        <td height="22" colspan="4" style="padding:5px;">
        <select name="MenuId52" id="MenuId52" onchange="ChangeSelect('Ajax.asp?Type=1&Id='+this.options[this.options.selectedIndex].value,'ModuleId52');">
                <option value="">请选择菜单</option>
<%
	Sqlstr="Select * From [Fk_Menu] Order By Fk_Menu_Id Asc"
	Rs.Open Sqlstr,Conn,1,3
...
%>
        ...
        <select name="ModuleId52" id="ModuleId52">
                <option value="">请先选择菜单</option>
        </select>
...
<%
		Case 30 '静态页常规标签
%>
<p><input style="width:550px;" type="text" class="Input" size="120" value="<div style='display:none;float:right;'><script type='text/javascript' src='{$TjUrl$}/counter.asp?id={$Tjid$}&icon=2'></script></div>" />&nbsp;&nbsp;&nbsp;&nbsp;统计代码</p>
<p><input style="width:550px;" class="Input" size="120" value="<script src='{$KfUrl$}/kf/?u={$Kfid$}'  charset='gb2312'></script>" />&nbsp;&nbsp;&nbsp;&nbsp;在线客服代码</p>
...
<p><input type="text" class="Input" style="width:550px" value="<script type=&quot;text/javascript&quot; src=&quot;{$SiteDir$}Click.asp?Type=1&Id={$ArticleId$}&quot;></script>" />&nbsp;&nbsp;&nbsp;&nbsp;新闻HTML点击JS，放置页面底部</p>
<%
...
<p><input type="text" class="Input" style="width:550px" value="<script type=&quot;text/javascript&quot; src=&quot;{$SiteDir$}Click.asp?Type=2&Id={$ProductId$}&quot;></script>" />&nbsp;&nbsp;&nbsp;&nbsp;图文HTML点击JS，放置页面底部</p>
<%
...
&nbsp;&nbsp;&nbsp;&nbsp;IF标签开始，比较方式支持&lt;/&gt;/=/&gt;=/&lt;=/&lt;&gt;</p>
<p><input type="text" class="Input" size="50" value="如果成立输出的HTML" /></p>
<p><input type="text" class="Input" size="50" value="{$Else$}" /></p>
<p><input type="text" class="Input" size="50" value="如果不成立输出的HTML" /></p>
...
<p><input type="text" class="Input" style="width:550px;" value="<script type=&quot;text/javascript&quot; src=&quot;{$SiteDir$}Click.asp?Type=3&Id={$DownId$}&quot;></script>" />&nbsp;&nbsp;&nbsp;&nbsp;下载HTML点击JS，放置页面底部</p>
<%
