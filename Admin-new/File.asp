...
%>
        <tr>
            <td height="20" colspan="3" style="padding-left:20px; height:31px"><a style="width:auto; line-height:21px;" href="javascript:void(0);" title="返回上层" onclick="SetRContent('MainRight','File.asp?Type=1&NowFloder=<%=DirFloder%>')">../</a></td>
        </tr>
<%
	End If
	If NowFloder="" Then
...
%>
        <tr>
            <td height="20" style="padding-left:20px;"><a style="width:auto; line-height:21px;" href="javascript:void(0);" onclick="SetRContent('MainRight','File.asp?Type=1&NowFloder=<%=NowFloder&ObjFloder.Name%>')"><%=ObjFloder.Name%></a></td>
            <td align="center">文件夹</td>
            <td align="center"><a style="width:auto; line-height:21px;" href="javascript:void(0);" onclick="SetRContent('MainRight','File.asp?Type=1&NowFloder=<%=NowFloder&ObjFloder.Name%>')">进入</a></td>
        </tr>
<%
	Next
...
%>
        <tr>
            <td height="20" style="padding-left:20px;"><a style="width:auto; line-height:21px;" href="../Up/<%=NowFloder&ObjFile.Name%>" target="_blank"><%=ObjFile.Name%></a></td>
            <td align="center">.<%=UCase(Split(ObjFile.Name,".")(UBound(Split(ObjFile.Name,"."))))%></td>
            <td align="center"><a style="width:auto; line-height:21px;" href="javascript:void(0);" onclick="DelIt('是否删除“<%=ObjFile.Name%>”？','File.asp?Type=2&File=<%=Server.URLEncode(NowFloder&ObjFile.Name)%>','MainRight','<%=Session("NowPage")%>');">删除</a></td>
        </tr>
<%
	Next
