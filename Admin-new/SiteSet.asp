...
$(document).ready(function(){
	...
	if(window.KindEditor){
		if(("#SiteLogo").length>0){
			$("#SiteLogo").after(" <input type=\"button\" id=\"uploadButton\" value=\"上传\" class=\"Button\" style=\"vertical-align:middle;\"/>&nbsp;&nbsp;&nbsp;&nbsp;( <span style=\"color:#999999\">图片格式：</span>jpg、gif、png    <span  style=\"color:#999999\">图片大小：</span><2MB )");
		...
		if(("#Sitepic1").length>0){
				...
				$("#Sitepic1").after(" <input type=\"button\" id=\"uploadButton1\" value=\"上传\" class=\"Button\" style=\"vertical-align:middle;\"/>&nbsp;&nbsp;&nbsp;&nbsp;( <span style=\"color:#999999\">图片格式：</span>jpg、gif、png    <span  style=\"color:#999999\">图片大小：</span><2MB )");
				...
				$("#Sitepic2").after(" <input type=\"button\" id=\"uploadButton2\" value=\"上传\" class=\"Button\" style=\"vertical-align:middle;\"/>&nbsp;&nbsp;&nbsp;&nbsp;( <span style=\"color:#999999\">图片格式：</span>jpg、gif、png    <span  style=\"color:#999999\">图片大小：</span><2MB )");
				...
				$("#Sitepic3").after(" <input type=\"button\" id=\"uploadButton3\" value=\"上传\" class=\"Button\" style=\"vertical-align:middle;\"/>&nbsp;&nbsp;&nbsp;&nbsp;( <span style=\"color:#999999\">图片格式：</span>jpg、gif、png    <span  style=\"color:#999999\">图片大小：</span><2MB )");
					...
					$("#Sitepic4").after(" <input type=\"button\" id=\"uploadButton4\" value=\"上传\" class=\"Button\" style=\"vertical-align:middle;\"/>&nbsp;&nbsp;&nbsp;&nbsp;( <span style=\"color:#999999\">图片格式：</span>jpg、gif、png    <span  style=\"color:#999999\">图片大小：</span><2MB )");
					...
					$("#Sitepic5").after(" <input type=\"button\" id=\"uploadButton5\" value=\"上传\" class=\"Button\" style=\"vertical-align:middle;\"/>&nbsp;&nbsp;&nbsp;&nbsp;( <span style=\"color:#999999\">图片格式：</span>jpg、gif、png    <span  style=\"color:#999999\">图片大小：</span><2MB )");
...
%></span><a onclick="layer.closeAll();$('select').show();"><img src="images/close3.gif"></a></div>-->
<div id="BoxContents" style="width:93%;">
	...
	<table width="100%" border="0" align="center" id="table001" style="display:<%
	if Snr=1 then
	...
	%>" cellpadding="0" cellspacing="0">
	 <tr>
            <td align="right" class="MainTableTop">LOGO标志</td>
            <td colspan="3" class="logoimg"><input name="SiteLogo" type="text" class="Input" id="SiteLogo" value="<%=SiteLogo%>" style="vertical-align:middle"/><%if SiteLogo<>"" then%><img onclick="this.src=document.getElementById('SiteLogo').value;" src="<%=SiteLogo%>" style="cursor:pointer; vertical-align:middle" title="LOGO预览 "><%end if%></td>
        </tr>
        <tr>
            <td  width="74" align="right" class="MainTableTop">公司名称</td>
            <td><input name="SiteName" type="text" class="Input" id="SiteName" value="<%=SiteName%>"   style="vertical-align:middle"/></td>
            <td  width="65" style="text-align:right">域名</td>
            <td><input name="SiteUrl" type="text" class="Input" id="SiteUrl" value="<%=SiteUrl%>"  style="vertical-align:middle"/></td>
        </tr>
        <tr>
            <td align="right" class="MainTableTop">电话</td>
            <td><input name="Tel" type="text" class="Input" id="Tel" value="<%=Tel%>"  style="vertical-align:middle"/></td>
            <td  style="text-align:right">400热线</td>
            <td>
			<input name="Tel400" type="text" class="Input" id="Tel400" value="<%=Tel400%>"  style="vertical-align:middle"/></td>
        </tr>
        <tr>
            <td align="right" class="MainTableTop">Email</td>
            <td><input name="Email" type="text" class="Input" id="Email" value="<%=Email%>"  style="vertical-align:middle"/></td>
            <td  style="text-align:right">传真</td>
            <td>
			<input name="Fax" type="text" class="Input" id="Fax" value="<%=Fax%>"  style="vertical-align:middle"/></td>
        </tr>
        <tr>
            <td align="right" class="MainTableTop">联系人</td>
            <td><input name="Lianxiren" type="text" class="Input" id="Lianxiren" value="<%=Lianxiren%>"  style="vertical-align:middle"/></td>
            <td  style="text-align:right">备案号</td>
            <td>
			<input name="beian" type="text" class="Input" id="beian" value="<%=beian%>"  style="vertical-align:middle"/></td>
        </tr>
        <tr>
            <td align="right" class="MainTableTop">地址</td>
            <td colspan="3"><input style="width:716px" name="Add" type="text" class="Input" id="Add" value="<%=Add%>"   style="vertical-align:middle"/>&nbsp;</td>
        </tr>
        <tr>
            <td align="right" class="MainTableTop">SEO标题</td>
            <td colspan="3"><input style="width:716px" name="SiteSeoTitle" type="text" class="Input" id="SiteSeoTitle" value="<%=SiteSeoTitle%>"   style="vertical-align:middle"/></td>
        </tr>
        <tr>
            <td align="right" class="MainTableTop">SEO关键词</td>
            <td colspan="3"><input style="width:716px" name="SiteKeyword" type="text" class="Input" id="SiteKeyword" value="<%=SiteKeyword%>"   style="vertical-align:middle"/></td>
        </tr>
        <tr>
            <td align="right" class="MainTableTop">SEO描述</td>
            <td colspan="3"><input style="width:716px" name="SiteDescription" type="text" class="Input" id="SiteDescription" value="<%=SiteDescription%>"   style="vertical-align:middle"/></td>
        </tr>
        <tr <%call AdminY()%>>
            <td align="right" class="MainTableTop">非法字符过滤</td>
            <td>
			<input name="SiteDelWord" class="Input" type="radio" id="SiteDelWord" value="1"<%=FKFun.BeCheck(SiteDelWord,1)%>  style="vertical-align:middle; width:auto; background:none; border:0"/>开启
            <input type="radio" name="SiteDelWord" class="Input" id="SiteDelWord" value="0"<%=FKFun.BeCheck(SiteDelWord,0)%>  style="vertical-align:middle; width:auto;"/>关闭</td>
            <td>每页条数</td>
...
%>
        ...
        <tr <%call AdminY()%>>
            <td align="right" class="MainTableTop">在线客服账号</td>
            <td><input name="Kfid" type="text" class="Input" id="Kfid" value="<%If curhost<>"localhost" and curhost<>"127.0.0.1" Then response.write Kfid Else response.write "anyya" End if%>" size="15" readonly style="vertical-align:middle; width:100px; margin-right:0;"/><input class="Button" type="button" value="自动获取" onclick="autoid('kfid');" <%If curhost="localhost" or curhost="127.0.0.1" Then response.write "disabled"%> name="B3" style="vertical-align:middle"><%If curhost="localhost" or curhost="127.0.0.1" Then response.write " <b style='color:red'>传到服务器后才能获取</b>" %>
</td>
            <td>统计账号</td>
            <td>
			<input name="Tjid" type="text" class="Input" id="Tjid" value="<%If curhost<>"localhost" and curhost<>"127.0.0.1" Then response.write Tjid Else response.write "544" End if%>" size="15" readonly style="vertical-align:middle; width:100px; margin-right:0;"/><input class="Button" type="button" value="自动获取" onclick="autoid('tjid');"  <%If curhost="localhost" or curhost="127.0.0.1" Then response.write "disabled"%> name="B3" style="vertical-align:middle"><%If curhost="localhost" or curhost="127.0.0.1" Then response.write " <b style='color:red'>传到服务器后才能获取</b>" %></td>
        </tr>
        <tr <%call AdminY()%> style="display:none">
            <td align="right" class="MainTableTop">飞信号码</td>
            <td><input name="FetionNum" type="text" class="Input" id="FetionNum" value="<%=FetionNum%>"  style="vertical-align:middle"/>&nbsp;&nbsp;&nbsp;<span id="Test" style="color:#F00;"><a href="javascript:void(0);" onclick="SetRContent('Test','SiteSet.asp?Type=3')">设置后测试</a></span></td>
            <td>飞信密码</td>
            <td><input name="FetionPass" type="password" class="Input" id="FetionPass" value="<%=FetionPass%>"  style="vertical-align:middle"/></td>
        </tr>
        
        <tr <%call AdminY()%>>
            <td align="right" class="MainTableTop">提取缩略</td>
            <td><input name="SiteMini" type="text" class="Input" id="SiteMini" value="<%=SiteMini%>"  style="vertical-align:middle; width:160px"/>个字符</td>
            <td>站点开放</td>
            <td>
			<input name="SiteOpen" class="Input" type="radio" id="SiteOpen" value="1"<%=FKFun.BeCheck(SiteOpen,1)%>  style="vertical-align:middle; width:auto;"/>开放
            <input type="radio" name="SiteOpen" class="Input" id="SiteOpen" value="0"<%=FKFun.BeCheck(SiteOpen,0)%>  style="vertical-align:middle; width:auto;"/>关闭</td>
        </tr>
        <tr <%call AdminY()%>>
            <td align="right" class="MainTableTop">模板</td>
            <td><select class="Input" name="SiteTemplate" id="SiteTemplate" style="vertical-align:middle; width:116px;">
    <%
...
%>
            ...
            <td>反垃圾</td>
            <td>
			<input name="SiteNoTrash" class="Input" type="radio" id="SiteNoTrash" value="1"<%=FKFun.BeCheck(SiteNoTrash,1)%>  style="vertical-align:middle; width:auto;"/>开启
            <input type="radio" name="SiteNoTrash" class="Input" id="SiteNoTrash" value="0"<%=FKFun.BeCheck(SiteNoTrash,0)%>  style="vertical-align:middle; width:auto;"/>关闭</td>
        </tr>
        <tr <%call AdminY()%>>
            <td align="right" class="MainTableTop">文件名生成</td>
            <td><input name="SiteToPinyin" class="Input" type="radio" id="SiteToPinyin" value="1"<%=FKFun.BeCheck(SiteToPinyin,1)%>  style="vertical-align:middle; width:auto;"/>自动生成拼音
            <input type="radio" name="SiteToPinyin" class="Input" id="SiteToPinyin" value="0"<%=FKFun.BeCheck(SiteToPinyin,0)%>  style="vertical-align:middle; width:auto;"/>不自动生成</td>
            <td>客服浮窗</td>
            <td>
			<input name="SiteQQ" class="Input" type="radio" id="SiteQQ" value="1"<%=FKFun.BeCheck(SiteQQ,1)%>  style="vertical-align:middle; width:auto;"/>开启
            <input type="radio" name="SiteQQ" class="Input" id="SiteQQ" value="0"<%=FKFun.BeCheck(SiteQQ,0)%>  style="vertical-align:middle; width:auto;"/>关闭</td>
        </tr>
               <tr <%call AdminY()%>>
            <td align="right" class="MainTableTop">是否生成</td>
            <td>
			<input name="SiteHtml" class="Input" type="radio" id="SiteHtml" value="1"<%=FKFun.BeCheck(SiteHtml,1)%>  style="vertical-align:middle; width:auto;"/>生成
                <input type="radio" name="SiteHtml" class="Input" id="SiteHtml" value="0"<%=FKFun.BeCheck(SiteHtml,0)%>  style="vertical-align:middle; width:auto;"/>不生成</td>
            <td>模板调试</td>
            <td>
			<input name="SiteTest" class="Input" type="radio" id="SiteTest" value="1"<%=FKFun.BeCheck(SiteTest,1)%> style="vertical-align:middle; width:auto;"/>开启
            <input type="radio" name="SiteTest" class="Input" id="SiteTest" value="0"<%=FKFun.BeCheck(SiteTest,0)%>  style="vertical-align:middle; width:auto;"/>关闭</td>
        </tr>
        <tr <%call AdminY()%>>
            <td align="right" class="MainTableTop">Index后缀</td>
            <td><input name="SiteFlash" class="Input" type="radio" id="SiteFlash" value="1"<%=FKFun.BeCheck(SiteFlash,1)%> style="vertical-align:middle; width:auto;"/>开启
            <input type="radio" name="SiteFlash" class="Input" id="SiteFlash" value="0"<%=FKFun.BeCheck(SiteFlash,0)%>  style="vertical-align:middle; width:auto;"/>关闭</td>
            <td>编辑器</td>
        ...
        <tr <%call AdminY()%>>
            <td align="left" class="MainTableTop" colspan="4">301跳转设置： 跳转至域名 <input type="text" class="Input" id="mainDomain" name="mainDomain" size="15"  value="<%=mHosts%>" style="vertical-align:middle; width:145px;"/>
              ，需跳转域名 <input name="Site301" size="30" class="Input" type="text" id="Site301" value="<%=toUrls%>" style="vertical-align:middle; width:145px;"/> 
            填写正式域名,多个以英文逗号隔开,格式:qebang.cn</td>
        </tr>
    </table>
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="ggcc" id="table002" style="display:<%
	if Snr=1 then
	response.write "none"
	else
	response.write "table"
	...
	%>" >
      <tr>
            ...
            <td colspan="3" style="line-height:25px;"><%if Sitepic1<>"" then%><img src="<%=Sitepic1%>" onclick="this.src=document.getElementById('Sitepic1').value;" style="cursor:hand;max-height:100px;width:300px;float:right;padding:1px;border:1px #CCCCCC solid;" title="小图预览[上传后点击更新] "><%end if%>图一：<input name="Sitepic1" type="text" class="Input sitepics" id="Sitepic1" value="<%=Sitepic1%>"  style="vertical-align:middle; width:180px; margin-right:3px;"/><br>
			链接：<input name="Sitepicurl1" type="text" class="Input" id="Sitepicurl1" value="<%=Sitepicurl1%>"   style="vertical-align:middle;"/>&nbsp;<br>
			文字：<input name="Sitepictext1" type="text" class="Input" id="Sitepictext1" value="<%=Sitepictext1%>"   style="vertical-align:middle"/></td>
        </tr>
         <tr>
            <td colspan="3" style="line-height:25px;"><%if Sitepic2<>"" then%><img src="<%=Sitepic2%>" onclick="this.src=document.getElementById('Sitepic2').value;"  style="cursor:hand;width:300px;max-height:100px;float:right;padding:1px;border:1px #CCCCCC solid;" title="小图预览[上传后点击更新] "><%end if%>图二：<input name="Sitepic2" type="text" class="Input sitepics" id="Sitepic2" value="<%=Sitepic2%>"  style="vertical-align:middle; width:180px; margin-right:3px;"/><br>
			链接：<input name="Sitepicurl2" type="text" class="Input" id="Sitepicurl2" value="<%=Sitepicurl2%>"   style="vertical-align:middle"/><br>
			文字：<input name="Sitepictext2" type="text" class="Input" id="Sitepictext2" value="<%=Sitepictext2%>"   style="vertical-align:middle"/></td>
        </tr>
         <tr>
            <td colspan="3" style="line-height:25px;"><%if Sitepic3<>"" then%><img src="<%=Sitepic3%>" onclick="this.src=document.getElementById('Sitepic3').value;"  style="cursor:hand;width:300px;max-height:100px;float:right;padding:1px;border:1px #CCCCCC solid;" title="小图预览[上传后点击更新] "><%end if%>图三：<input name="Sitepic3" type="text" class="Input sitepics" id="Sitepic3" value="<%=Sitepic3%>"  style="vertical-align:middle; width:180px; margin-right:3px;"/><br>
			链接：<input name="Sitepicurl3" type="text" class="Input" id="Sitepicurl3" value="<%=Sitepicurl3%>"   style="vertical-align:middle"/><br>
			文字：<input name="Sitepictext3" type="text" class="Input" id="Sitepictext3" value="<%=Sitepictext3%>"   style="vertical-align:middle"/></td>
        </tr>
         <tr <%call AdminY()%>>
            <td colspan="3" style="line-height:25px;"><%if Sitepic4<>"" then%><img src="<%=Sitepic4%>" onclick="this.src=document.getElementById('Sitepic4').value;"  style="cursor:hand;width:300px;max-height:100px;float:right;padding:1px;border:1px #CCCCCC solid;vertical-align:middle" title="小图预览[上传后点击更新] "><%end if%>图四：<input name="Sitepic4" type="text" class="Input sitepics" id="Sitepic4" value="<%=Sitepic4%>"  style="vertical-align:middle; width:180px; margin-right:3px;"/><br>
			链接：<input name="Sitepicurl4" type="text" class="Input" id="Sitepicurl4" value="<%=Sitepicurl4%>"   style="vertical-align:middle"/><br>
			文字：<input name="Sitepictext4" type="text" class="Input" id="Sitepictext4" value="<%=Sitepictext4%>"   style="vertical-align:middle"/></td>
        </tr>
         <tr <%call AdminY()%>>
            <td colspan="3" style="line-height:25px;"><%if Sitepic5<>"" then%><img src="<%=Sitepic5%>" onclick="this.src=document.getElementById('Sitepic5').value;"  style="cursor:hand;width:300px; max-height:100px; float:right;padding:1px;border:1px #CCCCCC solid;vertical-align:middle" title="小图预览[上传后点击更新] "><%end if%>图五：<input name="Sitepic5" type="text" class="Input sitepics" id="Sitepic5" value="<%=Sitepic5%>"  style="vertical-align:middle; width:180px; margin-right:3px;"/><br>
			链接：<input name="Sitepicurl5" type="text" class="Input" id="Sitepicurl5" value="<%=Sitepicurl5%>"   style="vertical-align:middle"/><br>
			文字：<input name="Sitepictext5" type="text" class="Input" id="Sitepictext5" value="<%=Sitepictext5%>"   style="vertical-align:middle"/></td>
        </tr>
        
    </table>
</div>
<div id="BoxBottom" style="width:96%;" class="tcbtm">
        <input style="margin-left:0;" type="submit" onclick="Sends('SystemSet','SiteSet.asp?Type=2',0,'',0,0,'','');" class="Button" name="button" id="button" value="保存设置" />
