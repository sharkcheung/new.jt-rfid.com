...
<div id="ListContent">
	<div class="gnsztopbtn">
    	<h3>广告管理</h3>
        <a class="sixjis" style="width:90px; padding-left:30px;" href="javascript:void(0);" onclick="ShowBox('Abd.asp?Type=2','添加新广告');">添加新广告</a>
    </div>
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
            <th align="center" class="ListTdTop">编号</th>
            <th align="center" class="ListTdTop">名称</th>
            <th align="center" class="ListTdTop">文件名</th>
            <th align="center" class="ListTdTop">JS文件</th>
...
%>
        <tr>
            ...
            <td>&nbsp;<%=Rs("Fk_Ad_Name")%>&nbsp;&nbsp;<a style="width:auto; line-height:21px;" href="javascript:void(0);" onclick="window.clipboardData.setData('Text','<script type=text/javascript src=<%=SiteDir%>GG/<%=Rs("Fk_Ad_File")%>.js></script>');alert('广告代码复制成功');">[复制代码]</a></td>
            <td align="center"><%=Rs("Fk_Ad_File")%></td>
            <td align="center"><%If FKFso.IsFile("../GG/"&Rs("Fk_Ad_File")&".js") Then%>存在<%Else%>不存在<%End If%></td>
            <td align="center" class="no6"><a class="no2" href="javascript:void(0);" onclick="ShowBox('Abd.asp?Type=4&Id=<%=Rs("Fk_Ad_Id")%>','修改广告');"></a> <a class="no4" href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("Fk_Ad_Name")%>”，此操作不可逆！','Abd.asp?Type=6&Id=<%=Rs("Fk_Ad_Id")%>','MainRight','Abd.asp?Type=1');"></a></td>
        </tr>
<%
			Rs.MoveNext
		Wend
...
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td><textarea style="border:1px solid #ccc; padding:5px; font-size:12px; color:#999; margin:10px;" name="Fk_Ad_Content" cols="60" rows="10" class="TextArea" id="Fk_Ad_Content"></textarea></td>
        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left;" class="tcbtm">
        <input style="margin-left:113px" type="submit" onclick="Sends('AdAdd','Abd.asp?Type=3',0,'',0,1,'MainRight','Abd.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
...
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td><textarea  style="border:1px solid #ccc; padding:5px; font-size:12px; color:#999; margin:10px;" name="Fk_Ad_Content" cols="60" rows="10" class="TextArea" id="Fk_Ad_Content"><%=Fk_Ad_Content%></textarea></td>
        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:93%; margin:0 auto; text-align:left;" class="tcbtm">
		<input type="hidden" name="Id" value="<%=Id%>" />
        <input style="margin-left:113px;" type="submit" onclick="Sends('AdEdit','Abd.asp?Type=5',0,'',0,1,'MainRight','Abd.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="layer.closeAll();$('select').show();" class="Button close" name="button" id="button" value="关 闭" />
</div>
</form>
<%
