...
<div class="xgzstop_top gnsztopbtn">
	<a class="no4" href="javascript:void(0);" onclick="ShowBox('Word.asp?Type=2','添加关键词内链');return false;">添加</a>
</div>
<table width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
	<th align="center" class="ListTdTop" width="120">编号</th>
	<th align="center" class="ListTdTop" width="140">关键词</th>
	<th align="center" class="ListTdTop">优先级别</th>
	<th align="center" class="ListTdTop" width="390">链接 </th>
	<th align="center" class="ListTdTop" width="108">操作</th>
	</tr>
<%
...
%>
	<tr>
		<td style="height:33px; padding-left:20px"><%=Rs("Fk_Word_Id")%></td>
		...
		<td align="center"><a href="javascript:void(0);" onclick="ShowBox('Word.asp?Type=4&Id=<%=Rs("Fk_Word_Id")%>');" title="修改 ">修改</a> <a href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("Fk_Word_Name")%>”，此操作不可逆！','Word.asp?Type=6&Id=<%=Rs("Fk_Word_Id")%>','MainRight','<%=Session("NowPage")%>');" title="删除 ">删除</a></td>
	</tr>
<%
			Rs.MoveNext
			i=i+1
...
%>
	<tr class="last">
		<td colspan="5">&nbsp;<%Call FKFun.ShowPageCode("Word.asp?Type=1&usertype="&request("usertype")&"&token="&request("token")&"&mobile="&request("mobile")&"&Page=",PageNow,PageAll,PageSizes,PageCounts)%></td>
	</tr>
<%
	Else
%>
...
<div id="BoxContents" style="width:93%; padding-top:10px;">
	<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="33" align="right">关键词：</td>
	        <td>&nbsp;<input name="Fk_Word_Name" type="text" class="Input" id="Fk_Word_Name" /></td>
	        </tr>
	    <tr>
	        <td height="33" align="right">优先级别：</td>
	    ...
	    <tr>
	        <td height="33" align="right">链接：</td>
