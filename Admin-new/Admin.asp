...
<h3>账号管理</h3>
<a class="sixjis" style="width:95px;padding-left:25px" href="javascript:void(0);" onclick="ShowBox('Admin.asp?Type=2','添加新管理员','450px');">添加新管理员</a>
</div>
    <table width="100%" cellspacing="0" cellpadding="0">
        <tr>
            <th align="center" class="no1">编号</th>
            <th>用户名</td>
            <th>姓名</td>
            <th>权限</td>
            <th>状态</td>
...
%>
        <tr <%=d%>>
            <td class="no1"><%=Rs("Fk_Admin_Id")%></td>
            <td align="left"><%=Rs("Fk_Admin_LoginName")%></td>
            ...
            <td align="left" class="no6"><div class="gnszcaozuo"><a title="修改管理员" href="javascript:void(0);" onclick="ShowBox('Admin.asp?Type=4&Id=<%=Rs("Fk_Admin_Id")%>','修改管理员');" class="no2" style="vertical-align:middle; margin:0;">&nbsp;</a>　<%If FkFun.CheckLimit("System22") Then
			if trim(Request.Cookies("FkAdminName"))<>trim(Rs("Fk_Admin_LoginName")) then%><a href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("Fk_Admin_Name")%>”，此操作不可逆！','Admin.asp?Type=6&Id=<%=Rs("Fk_Admin_Id")%>','MainRight','Admin.asp?Type=1');" class="no4">
			&nbsp;</a><%end if
			end if%></div></td>
        </tr>
<%
...
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30" align="right" width="100">登录名：</td>
...
<div id="BoxBottom" style="width:93%; margin: 0 auto; text-align:left;" class="tcbtm">
        <input style="margin-left:113px;" type="submit" onclick="Sends('AdminAdd','Admin.asp?Type=3',0,'',0,1,'MainRight','Admin.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
...
<div id="BoxContents" style="width:93%; padding-top:20px;">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td height="30" width="100" align="right">登录名：</td>
...
<div id="BoxBottom" style="width:93%; margin: 0 auto; text-align:left;" class="tcbtm">
        ...
        <input type="submit" style="margin-left:113px;" onclick="Sends('AdminEdit','Admin.asp?Type=5',0,'',0,1,'MainRight','Admin.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="layer.closeAll();$('select').show();" class="Button close" name="button" id="button" value="关 闭" />
</div>
</form>
<%
