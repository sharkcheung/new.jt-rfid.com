...
<div id="ListContent">
	<div class="gnsztopbtn">
    	<h3><%=Fk_Module_Name%>模块&nbsp;&nbsp;</h3><span style="float:left; line-height:27px; padding-left:20px;">请选择模块：</span>
...
%>
		...
		<a class="no3" href="javascript:void(0);" onclick="SetRContent('MainRight','GBook.asp?Type=1&ModuleId=<%=Fk_Module_Id%>');return false">刷新内容</a>
    </div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <th align="center" class="ListTdTop">编号</th>
            <th align="left" class="ListTdTop" width="200">&nbsp;&nbsp;标题</th>
            <th align="center" class="ListTdTop">联系人</th>
            <th align="center" class="ListTdTop">联系方式</th>
            <th align="center" class="ListTdTop">来源IP</th>
            <th align="center" class="ListTdTop">时间</th>
            <th align="center" class="ListTdTop">回复时间</th>
...
%>
        <tr>
            ...
            <td align="center" class="no6"><a class="huifu" href="javascript:void(0);" onclick="ShowBox('GBook.asp?Type=2&ModuleId=<%=Fk_Module_Id%>&Id=<%=Rs("Fk_GBook_Id")%>','互动回复');"></a> <a class="no4" href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("Fk_GBook_Name")%>”？此操作不可逆！','GBook.asp?Type=4&ModuleId=<%=Fk_Module_Id%>&Id=<%=Rs("Fk_GBook_Id")%>','MainRight','<%=Session("NowPage")%>');"></a></td>
        </tr>
<%
			Rs.MoveNext
			i=i+1
...
%>
        <tr>
            <td height="30" colspan="8" align="center">&nbsp;<%Call FKFun.ShowPageCode("GBook.asp?Type=1&ModuleId="&Fk_Module_Id&"&Page=",PageNow,PageAll,PageSizes,PageCounts)%></td>
        </tr>
<%
	Else
%>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td style="padding:10px 0"><textarea style="width:90%; padding:5px; font-size:12px; color:#555; border:1px solid #ccc;" name="Fk_GBook_ReContent" cols="70" rows="5" class="TextArea" id="Fk_GBook_ReContent"><%=Fk_GBook_ReContent%></textarea></td>
    </tr>
</table>
</div>
