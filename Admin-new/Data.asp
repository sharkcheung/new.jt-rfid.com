...
<div id="ListContent">
	<div class="gnsztopbtn">
    	<h3>数据维护</h3>
        <a class="shuax" href="javascript:void(0);" onclick="SetRContent('MainRight','Data.asp?Type=1');return false">刷新</a>
    </div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <th align="center" class="ListTdTop">数据维护</th>
        </tr>
        <tr>
            <td align="center">数据整理：
                <input style="vertical-align:middle" type="button" onclick="DelIt('是否要整理数据？','Data.asp?Type=3','MainRight','Data.asp?Type=1');" class="Button" name="button" id="button" value="整 理" /> 
			整理数据有利于提供运行效率，建议每月运行一次。</td>
        </tr>
        <tr>
            <td align="center">数据备份：
                <input style="vertical-align:middle" type="button" onclick="DelIt('是否要备份数据？','Data.asp?Type=4','MainRight','Data.asp?Type=1');" class="Button" name="button" id="button" value="备 份" /> 
			备份数据名以当前日期为命名，建议每周运行一次。</td>
        </tr>
        <tr>
            <td align="center" style="border:0;">数据恢复：不能直接在此恢复数据，需恢复备份数据，请联系您的客服人员。</td>
        </tr>
        <tr>
            <th align="center" class="ListTdTop">空间占用</th>
        </tr>
        <tr>
            <td align="center">占用空间：<%=GetSize(SiteDir)%>；附件占用：<%=GetSize(SiteDir&"Up")%></td>
        </tr>
    </table>
</div>
<div id="ListBottom">
