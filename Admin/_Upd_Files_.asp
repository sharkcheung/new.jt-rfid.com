...
function chkUpdate()
	...
	updVersionUrl="http://upd-files.qebang.cn/Version.asp"
...
If upd="update" then
	...
	With objUpdate
		.UrlVersion = "http://upd-files.qebang.cn/Version.asp?r="&Date()
	...
	If chkUpdate() Then
		Response.Write("<p>系统检测到有更新<br><a href='?upd=update'><img src='http://image001.dgcloud01.qebang.cn/website/update.png'></a></p>")
	Else
