...
<div id="ListNav">
    <ul>
        <li><a href="javascript:void(0);" onclick="ShowBox('FriendsType.asp?Type=2');">添加类型</a></li>
        <li><a href="javascript:void(0);" onclick="SetRContent('MainRight','Friends.asp?Type=1');return false">返回列表</a></li>
    </ul>
</div>
<div id="ListTop">
    友情链接类型管理
...
%>
        <tr>
            ...
            <td align="center"><a href="javascript:void(0);" title="修改 " onclick="ShowBox('FriendsType.asp?Type=4&Id=<%=Rs("Fk_FriendsType_Id")%>');"><img src="images/edit.png"></a> 　  <%If Request.Cookies("FkAdminLimitId")=0 Then%><a title="删除 " href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("Fk_FriendsType_Name")%>”，此操作不可逆！','FriendsType.asp?Type=6&Id=<%=Rs("Fk_FriendsType_Id")%>','MainRight','FriendsType.asp?Type=1');">删除</a><%end if%></td>
        </tr>
<%
			Rs.MoveNext
		Wend
...
<div id="BoxTop" style="width:98%;"><span>添加友情链接类型</span></div>
...
<div id="BoxBottom" style="width:96%;">
        <input type="submit" onclick="Sends('FriendsTypeAdd','FriendsType.asp?Type=3',0,'',0,1,'MainRight','FriendsType.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
...
<div id="BoxTop" style="width:98%;"><span>修改友情链接类型</span></div>
<div id="BoxContents" style="width:98%;">
	<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right">类型名称：</td>
...
<div id="BoxBottom" style="width:96%;">
        ...
        <input type="submit" onclick="Sends('FriendsTypeEdit','FriendsType.asp?Type=5',0,'',0,1,'MainRight','FriendsType.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="$('#Boxs').hide();$('select').show();" class="Button" name="button" id="button" value="关 闭" />
</div>
</form>
<%
