...
<div id="ListNav">
    <ul>
        ...
        <li><a href="javascript:void(0);" onclick="SetRContent('MainRight','Template.asp?Type=8');return false">模板缓存列表</a></li>
    </ul>
</div>
<div id="ListTop">
    模板管理
...
%>
        <tr>
            <td height="20" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" title="返回上层" onclick="SetRContent('MainRight','Template.asp?Type=1&NowFloder=<%=DirFloder%>');return false">../</a></td>
        </tr>
<%
	End If
	If NowFloder="" Then
...
%>
        <tr>
            <td height="20">&nbsp;&nbsp;<a href="javascript:void(0);" onclick="SetRContent('MainRight','Template.asp?Type=1&NowFloder=<%=NowFloder&ObjFloder.Name%>');return false;"><%=ObjFloder.Name%></a></td>
            <td align="center">文件夹</td>
            <td align="center"><a href="javascript:void(0);" onclick="SetRContent('MainRight','Template.asp?Type=1&NowFloder=<%=NowFloder&ObjFloder.Name%>');return false;">进入</a></td>
        </tr>
<%
	Next
...
%>
        <tr>
            <td height="20">&nbsp;&nbsp;<a href="javascript:void(0);" onclick="ShowBox('Template.asp?Type=4&File=<%=ObjFile.Name%>&NowFloder=<%=NowFloder%>');return false"><%=ObjFile.Name%></a></td>
            <td align="center">.<%=UCase(Split(ObjFile.Name,".")(UBound(Split(ObjFile.Name,"."))))%></td>
            <td align="center"><a href="javascript:void(0);" onclick="ShowBox('Template.asp?Type=4&File=<%=ObjFile.Name%>&NowFloder=<%=NowFloder%>');return false">修改</a></td>
        </tr>
<%
		End If
	Next
...
<div id="BoxTop" style="width:700px;">添加新模板文件[按ESC关闭窗口]</div>
<div id="BoxContents" style="width:700px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>&nbsp;<textarea name="Fk_Template_Content" cols="65" rows="20" class="TextArea" id="Fk_Template_Content"></textarea></td>
        </tr>
	</table>
</div>
...
<div id="BoxTop" style="width:700px;">修改模板[按ESC关闭窗口]</div>
<div id="BoxContents" style="width:700px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30" align="right">文件名：</td>
        ...
        <tr>
            <td height="30" align="right">文件内容：</td>
            <td>&nbsp;<textarea name="Fk_Template_Content" cols="65" rows="20" class="TextArea" id="Fk_Template_Content"><%=Fk_Template_Content%></textarea></td>
        </tr>
	</table>
</div>
<div id="BoxBottom" style="width:680px;">
        ...
        <input type="submit" onclick="Sends('TemplateEdit','Template.asp?Type=5',0,'',0,1,'MainRight','<%=Session("NowPage")%>');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="$('#Boxs').hide();$('select').show();" class="Button" name="button" id="button" value="关 闭" />
</div>
</form>
<%
...
<div id="ListNav">
    <ul>
        <li><a href="javascript:void(0);" onclick="SetRContent('MainRight','Template.asp?Type=1');return false">模板文件列表</a></li>
    </ul>
</div>
<div id="ListTop">
    模板缓存管理
...
%>
        <tr>
            ...
            <td align="center"><a href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("Fk_Template_Name")%>”，此操作不可逆！','Template.asp?Type=9&Id=<%=Rs("Fk_Template_Id")%>','MainRight','<%=Session("NowPage")%>');return false">删除</a></td>
        </tr>
<%
			Rs.MoveNext
		Wend
