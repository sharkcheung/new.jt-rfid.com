...
fileExtStr = "doc|docx|xls|xlsx|ppt|txt|zip|rar|7z|pdf|mp4"
...
Select Case dirName
	Case "flash" extStr = flashExtStr:maxSize = 5 * 1024 * 1024 '5M
	Case "media" extStr = mediaExtStr:maxSize = 5 * 1024 * 1024 '5M
	Case "file" extStr = fileExtStr:maxSize = 5 * 1024 * 1024 '5M
