...
<div id="ListNav">
    <ul>
        <li><a href="javascript:void(0);" onclick="ShowBox('Vote.asp?Type=2');">添加调查</a></li>
    </ul>
</div>
<div id="ListTop">
    市场调查管理
...
%>
        <tr>
            ...
            <td>&nbsp;<%=Rs("Fk_Vote_Name")%>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="window.clipboardData.setData('Text','<script type=text/javascript src=<%=SiteDir%>Vote.asp?Id=<%=Rs("Fk_Vote_Id")%>></script>');alert('市场调查代码复制成功');">[复制代码]</a></td>
            <td align="center"><a href="javascript:void(0);" title="修改 " onclick="ShowBox('Vote.asp?Type=4&Id=<%=Rs("Fk_Vote_Id")%>');"><img src="images/edit.png"></a> <a href="javascript:void(0);" title="删除 " onclick="DelIt('您确认要删除“<%=Rs("Fk_Vote_Name")%>”，此操作不可逆！','Vote.asp?Type=6&Id=<%=Rs("Fk_Vote_Id")%>','MainRight','Vote.asp?Type=1');"><img src="images/del.png"></a></td>
        </tr>
<%
			Rs.MoveNext
		Wend
...
<div id="BoxTop" style="width:700px;">添加新市场调查[按ESC关闭窗口]</div>
<div id="BoxContents" style="width:700px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right">名称：</td>
	        <td>&nbsp;<input name="Fk_Vote_Name" type="text" class="Input" id="Fk_Vote_Name" size="40" /></td>
	        </tr>
        <tr>
            <td height="30" align="right">条目：</td>
            <td>&nbsp;<textarea name="Fk_Vote_Content" cols="60" rows="10" class="TextArea" id="Fk_Vote_Content"></textarea></td>
        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:680px;">
        <input type="submit" onclick="Sends('VoteVoted','Vote.asp?Type=3',0,'',0,1,'MainRight','Vote.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
...
<div id="BoxTop" style="width:700px;">修改市场调查[按ESC关闭窗口]</div>
<div id="BoxContents" style="width:700px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right">名称：</td>
	        <td>&nbsp;<input name="Fk_Vote_Name" value="<%=Fk_Vote_Name%>" type="text" class="Input" id="Fk_Vote_Name" size="40" /></td>
	        </tr>
        <tr>
            <td height="30" align="right">条目：</td>
            <td>&nbsp;<textarea name="Fk_Vote_Content" cols="60" rows="10" class="TextArea" id="Fk_Vote_Content"><%=Fk_Vote_Content%></textarea></td>
        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:680px;">
		<input type="hidden" name="Id" value="<%=Id%>" />
        <input type="submit" onclick="Sends('VoteEdit','Vote.asp?Type=5',0,'',0,1,'MainRight','Vote.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="$('#Boxs').hide();$('select').show();" class="Button" name="button" id="button" value="关 闭" />
</div>
</form>
<%
