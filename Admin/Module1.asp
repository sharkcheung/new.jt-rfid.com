...
<div id="ListNav">
    <ul>
        ...
        <li><a title="栏目排序 " href="javascript:void(0);" onclick="SetRContent('MainRight','Module.asp?Type=7&MenuId=<%=MenuId%>');">栏目排序</a></li>
        <%If FkFun.CheckLimit("System5") Then%><li><a title="更新缓存 " href="javascript:void(0);" onclick="DelIt('需要更新缓存么？','Template.asp?Type=6','MainRight','<%=Session("NowPage")%>');">更新缓存</a></li><%End If%>
    </ul>
</div>
<div id="ListTop">
    <%'=Fk_Menu_Name%>栏目管理
...
<div id="ListContent">
    <table width="100%" bordercolor="#CCCCCC" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td align="left" class="ListTdTop">预览&nbsp;&nbsp;静态生成名</td>
...
<div id="ListNav">
    <ul>
        <li><a href="javascript:void(0);" onclick="SetRContent('MainRight','Module.asp?Type=1&MenuId=<%=MenuId%>');">返回栏目列表</a></li>
    </ul>
</div>
<div id="ListTop">
    <%=Fk_Menu_Name%>菜单栏目排序
...
Public Function ShowModuleListM(MenuIds,LevelId,TitleBack)
	...
	<tr>
		...
		<td align="left"><a title="预览 " target="_blank" href='<%If Rs2("Fk_Module_Type")=5 Then%>
