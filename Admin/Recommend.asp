...
<div id="BoxBottom" style="width:380px;">
        <input type="submit" onclick="Sends('RecommendAdd','Recommend.asp?Type=3',0,'',0,1,'MainRight','Recommend.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
...
<div id="BoxBottom" style="width:380px;">
        ...
        <input type="submit" onclick="Sends('RecommendEdit','Recommend.asp?Type=5',0,'',0,1,'MainRight','Recommend.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="$('#Boxs').hide();$('select').show();" class="Button" name="button" id="button" value="关 闭" />
</div>
</form>
<%
