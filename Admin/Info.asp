...
<div id="BoxTop" style="width:98%;"><span>修改<%=Fk_Module_Name%></span><a onclick="$('#Boxs').hide();$('select').show();"><img src="images/close3.gif"></a></div>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
        ...
        <td><textarea name="Fk_Module_Content" class="<%=bianjiqi%>" id="Fk_Module_Content" rows="15" style="width:100%;"><%=Fk_Module_Content%></textarea></td>
    </tr>
    <tr>
