...
<div id="ListContent" style="width:98%;margin-left:8px;background-color:#FFF;border-left:1px solid #7998B7;border-right:1px solid #7998B7;border-bottom:1px solid #D7E0E7;">
    ...
    <table width="100%" bordercolor="#CCCCCC" border="1" cellspacing="0" cellpadding="0">
        <tr>
            <td align="center" class="ListTdTop">编号</td>
            <td align="left" class="ListTdTop">栏目名称</td>
            <td align="center" class="ListTdTop">seo标题 <font style="font-weight:normal;">　(<50个汉字[100个字符])</font></td>
            <td align="center" class="ListTdTop">关键词Keywords <font style="font-weight:normal;">　(<50个汉字[100个字符]，逗号间隔)</font></td>
            <td align="center" class="ListTdTop">描述Description <font style="font-weight:normal;">　(<100汉字[200个字符],3句为宜。)</font></td>
        </tr>
<%
...
%>
        <tr>
            ...
            <input type="hidden" name="MenuId" value="<%=MenuId%>" />
            <input type="submit" name="Submits" class="Button" id="Submits" value="设置" onclick="Sends('ModuleOrderSet','ModuleSEO.asp?Type=8',1,'file-shangwin.asp?filename=Moduleseo&Viewstyle=7',0,0,'','');" />&nbsp;&nbsp;
...
Sub ModuleOrderDo()
	...
	While Not Rs.Eof
		...
		Call FKFun.ShowString(Fk_Module_Keyword,1,100,2,"请输入站点关键字！",Rs("Fk_Module_Name")&"关键词不能大于100个字符！")
		Fk_Module_Description=Trim(Request.Form("Fk_Module_Description"&Rs("Fk_Module_Id")))
		Call FKFun.ShowString(Fk_Module_Description,1,200,2,"请输入站点描述！",Rs("Fk_Module_Name")&"描述不能大于200个字符！")
...
Public Function OrderModuleListM(MenuIds,LevelId,TitleBack)
	...
	<tr>
		<td height="22" align="center"><%=Rs2("Fk_Module_Id")%></td>
		<td align="left">&nbsp;&nbsp;<%=TitleBack%><%=Rs2("Fk_Module_Name")%></td>
		<td align="center"><textarea name="Fk_Module_Seotitle<%=Rs2("Fk_Module_Id")%>" id="Fk_Module_Seotitle<%=Rs2("Fk_Module_Id")%>" cols="25" rows="2" class="TextArea2"><%=Rs2("Fk_Module_Seotitle")%></textarea></td>
		<td align="center"><textarea name="Fk_Module_Keyword<%=Rs2("Fk_Module_Id")%>" id="Fk_Module_Keyword<%=Rs2("Fk_Module_Id")%>" cols="55" rows="2" class="TextArea2"><%=Rs2("Fk_Module_keyword")%></textarea></td>
		<td align="center"><textarea name="Fk_Module_Description<%=Rs2("Fk_Module_Id")%>" id="Fk_Module_Description<%=Rs2("Fk_Module_Id")%>" cols="65" rows="2" class="TextArea2"><%=Rs2("Fk_Module_Description")%></textarea></td>
	</tr>
<%
		If LevelId=0 Then
			TitleBacks="&nbsp;&nbsp;<span class='lm1'>└&nbsp;"
