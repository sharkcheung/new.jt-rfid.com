...
<div id="ListNav">
    <ul>
       <li><a href="javascript:void(0);" onclick="ShowBox('siteset.asp?Type=1&Snr=0')">广告橱窗</a></li>
 <%If Request.Cookies("FkAdminLimitId")=0 Then%><li><a href="javascript:void(0);" onclick="ShowBox('Infos.asp?Type=2');">添加模块</a></li><%end if%>
    </ul>
</div>
<div id="ListTop">
    模块设置
...
<div id="ListContent">
    <table width="100%" bordercolor="#CCCCCC" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td align="center" class="ListTdTop">模块标题</td>
            <td align="center" class="ListTdTop">模块内容</td>
            <td align="center" class="ListTdTop">修改</td>
        </tr>
<%
...
%>
        <tr>
            ...
            <td align="center"><a href="javascript:void(0);" title="修改 " onclick="ShowBox('Infos.asp?Type=4&Id=<%=Rs("Fk_Info_Id")%>');"><img src="images/edit.png"></a> <%If Request.Cookies("FkAdminLimitId")=0 Then%><a title="删除 " href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Rs("Fk_Info_Name")%>”，此操作不可逆！','Infos.asp?Type=6&Id=<%=Rs("Fk_Info_Id")%>','MainRight','Infos.asp?Type=1');"><img src="images/del.png"></a><%end if%></td>
        </tr>
<%
			Rs.MoveNext
		Wend
...
<div id="BoxTop" style="width:98%;"><span>添加新模块</span></div>
<div id="BoxContents" style="width:98%;">
	<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td><textarea name="Fk_Info_Content" class="<%=bianjiqi%>" style="width:100%;" rows="20" class="TextArea" id="Fk_Info_Content"></textarea></td>
        </tr>
	    </table>
</div>
...
<div id="BoxTop" style="width:98%;"><span>修改模块</span></div>
<div id="BoxContents" style="width:98%;">
	<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right">标题：</td>
        ...
        <tr>
            ...
            <td><textarea name="Fk_Info_Content" class="<%=bianjiqi%>" style="width:100%;" rows="20" class="TextArea" id="Fk_Info_Content"><%=Fk_Info_Content%></textarea></td>
        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:96%;">
