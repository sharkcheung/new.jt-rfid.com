...
<div id="BoxTop" style="width:750px;"><span>查看/处理订单</span><a onclick="$('#Boxs').hide();$('select').show();"><img src="images/close3.gif"></a></div>
<div id="BoxContents" style="width:750px;">

<table width="98%"border="1" align="center" cellpadding="5" cellspacing="0" class="tableBorder">
                          <tr > 
...
<div id="BoxBottom" style="width:730px;">
 <input type="submit" onclick="$('#Boxs').hide();$('select').show();Sends('SystemSet','viewdingdan.asp?action=del&oid=<%=oid%>&username=<%=username%>',0,'',0,0,'','');" class="Button" name="button" id="button" value="删除订单" />
