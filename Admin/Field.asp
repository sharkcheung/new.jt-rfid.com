...
<div id="ListNav">
    <ul>
        <li><a href="javascript:void(0);" onclick="ShowBox('Field.asp?Type=2');">添加自定义字段</a></li>
    </ul>
</div>
<div id="ListTop">
    自定义字段管理
...
<div id="ListContent">
    <table width="100%" bordercolor="#CCCCCC" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td align="center" class="ListTdTop">列表标签</td>
            <td align="center" class="ListTdTop">内容标签</td>
...
<div id="BoxTop" style="width:500px;">添加新自定义字段[按ESC关闭窗口]</div>
<div id="BoxContents" style="width:500px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>&nbsp;<input name="Fk_Field_Tag" type="text" class="Input" id="Fk_Field_Tag" size="20" />*输入单词即可，添加后不可修改</td>
        </tr>
        <tr>
...
<div id="BoxBottom" style="width:480px;">
        <input type="submit" onclick="Sends('FieldFieldd','Field.asp?Type=3',0,'',0,1,'MainRight','Field.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
...
<div id="BoxTop" style="width:500px;">修改自定义字段[按ESC关闭窗口]</div>
<div id="BoxContents" style="width:500px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right">名称：</td>
...
<div id="BoxBottom" style="width:480px;">
        ...
        <input type="submit" onclick="Sends('FieldEdit','Field.asp?Type=5',0,'',0,1,'MainRight','Field.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="$('#Boxs').hide();$('select').show();" class="Button" name="button" id="button" value="关 闭" />
</div>
</form>
<%
