...
<div id="ListNav">
    <ul>
        ...
        <li><a href="javascript:void(0);" onclick="ShowBox('ExtFunction.asp?Type=2');">添加表字段</a></li>
		<li><a href="javascript:void(0);" onclick="SetRContent('MainRight','ExtFunction.asp?Type=1');return false">刷新</a></li>
    </ul>
</div>
<div id="ListTop">
    表字段管理 <select name="fieldselect" id="fieldselect"><option value="Fk_Product">Fk_Product</option></select>
</div>
<div id="ListContent">
    <table width="100%" bordercolor="#CCCCCC" border="1" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td align="center" class="ListTdTop">字段大小</td>
            <td align="center" class="ListTdTop">字段说明</td>
            <td align="center" class="ListTdTop">是否允许空</td>
            <td align="center" class="ListTdTop">自动编号</td>
            <td align="center" class="ListTdTop">主键</td>
...
%>
        <tr>
            ...
            <td align="center"><a href="javascript:void(0);" onclick="ShowBox('ExtFunction.asp?Type=4&tbfield=<%=Key.name%>&tb='+fieldselect.value);">修改</a> <a href="javascript:void(0);" onclick="DelIt('您确认要删除“<%=Key.name%>”，此操作不可逆！','ExtFunction.asp?Type=6&tbfield=<%=Key.name%>&tb='+fieldselect.value,'MainRight','ExtFunction.asp?Type=1');">删除</a></td>
        </tr>
<%
		next 
...
<div id="BoxTop" style="width:500px;">添加新字段[按ESC关闭窗口]</div>
<div id="BoxContents" style="width:500px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	        <td height="25" align="right">表名称：</td>
	        <td><select id="tb" name="tb"><option value="Fk_Product">Fk_Product</select></td>
	        </tr>
        <tr>
	    <tr>
	        <td height="25" align="right">字段名称：</td>
	        <td><input name="fldname" type="text" size="30" maxlength="50"></td>
	        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input name="fldsize" type="text" size="30" maxlength="50"></td>
        </tr>
        <tr>
            <td height="30" align="right">字段说明：</td>
            <td><input name="desc" type="text" value="" size="30" maxlength="50"></td>
        </tr>
        <!--tr>
        ...
        <tr>
            ...
            <td><input type="checkbox" name="autoincrement" value="ON"></td>
        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:480px;">
        <input type="submit" onclick="Sends('FieldFieldd','ExtFunction.asp?Type=3',0,'',0,1,'MainRight','ExtFunction.asp?Type=1');" class="Button" name="button" id="button" value="添 加" />
...
<div id="BoxContents" style="width:500px;">
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td height="30" align="right">字段大小：</td>
            <td><input name="size" type="text" value="<%=iif(rs(i).type=203,"",rs(i).definedsize)%>" size="30" maxlength="50"></td>
        </tr>
        <tr>
            <td height="30" align="right">字段说明：</td>
            <td><input name="desc" type="text" value="<%=getDesc(tb,tbfield)%>" size="30" maxlength="50"></td>
        </tr>
        <!--tr>
            <td height="30" align="right">是否允许为空：</td>
        ...
        <tr>
            <td height="30" align="right">自动编号：</td>
            <td><input type="checkbox" name="autoincrement" value="y"<%=iif(rs(i).Properties("ISAUTOINCREMENT") = True," checked","")%> /></td>
        </tr>
	    </table>
</div>
<div id="BoxBottom" style="width:480px;">
        ...
        <input type="submit" onclick="Sends('FieldEdit','ExtFunction.asp?Type=5',0,'',0,1,'MainRight','ExtFunction.asp?Type=1');" class="Button" name="button" id="button" value="修 改" />
        <input type="button" onclick="$('#Boxs').hide();$('select').show();" class="Button" name="button" id="button" value="关 闭" />
</div>
</form>
<%
